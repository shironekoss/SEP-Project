...
<html lang="en">
   ...
   <body class="main-layout">
      <!-- loader  -->
      <div class="loader_bg">
         <div class="loader"><img src="{{ asset('images/gchoco/loading.gif') }}" alt="#"/></div>
      </div>
      <!-- end loader -->
      <!-- header -->
      <div class="wrapper">
         ...
         <nav id="sidebar">
            <div class="sidebar-header">
               <div class="logo">
                  <a href="index.html"><img src="{{ asset('images/gchoco/logo.png') }}" alt="#"/></a>
               </div>
            </div>
            <ul class="list-unstyled components">
               <li class="active">
                  <a href="combos.html"> <i class="fa fa-angle-right" aria-hidden="true"></i>Order Now</a>
               </li>
               <li>
                  <a href="luxury.html"> <i class="fa fa-angle-right" aria-hidden="true"></i>Luxury Chocolates</a>
               </li>
               <li>
                  <a href="sugarfree.html"> <i class="fa fa-angle-right" aria-hidden="true"></i>Sugar Free Chocolates</a>
               </li>
               <li>
                  <a href="product.html"> <i class="fa fa-angle-right" aria-hidden="true"></i>product</a>
               </li>
               <li>
         ...
         <div id="content">
            <div class="informesion_top">
               <div class="container">
                  <div class="row">
                     <div class="col-md-9">
                        <nav class="navbar navbar-expand-lg navbar-light testop_none">
                           <div class="container-fluid">
                              <button type="button" id="sidebarCollapse" class="btn btn-info">
                              <img src="{{ asset('images/gchoco/menu_icon.png') }}" alt="#"/>
                              </button>
                           </div>
                        </nav>
                     </div>
                                    ...
                                    <div class="carousel-caption relative">
                                       <div class="row">
                                          <div  class="col-md-12">
                                             <div class="designer">
                                                <h1>Chocolates</h1>
                                                <span>long established fact that a reader will be distracted by the readable content </span>
                                                <figure><img src="{{ asset('images/gchoco/choc.png') }}" alt="#"/></figure>
                                                <div class="cho_more">
                                    ...
                                    <div class="col-md-6">
                                       <div class="orders_box text_align_left">
                                          <div class="orders_img">
                                             <figure><img src="{{ asset('images/ramen/Shoyuramenrumputlaut.jpg') }}" alt="#"/></figure>
                                             <div class="price">
                                                <span>PRICE<br>Rp 20.000</span>
                                             </div>
                                          </div>
                                          <div class="party">
                                             <h3>Shoyu ramen Rumput Laut</h3>
                                          </div>
                                          <a class="read_more" href="Javascript:void(0)">Beli Sekarang</a>
                                       </div>
                                    </div>
                                    <div class="col-md-6">
                                       <div class="orders_box text_align_left">
                                          <div class="orders_img">
                                             <figure><img src="{{ asset('images/gchoco/orders2.png') }}" alt="#"/></figure>
                                             <div class="price">
                                                <span>PRICE<br>$300</span>
                                             </div>
                                          </div>
                                          <div class="party">
                                             <h3>PARTY CHOCLATE</h3>
                                          </div>
                              ...
                              <div class="carousel-caption">
                                 <div class="row">
                                    <div class="col-md-6">
                                       <div class="orders_box text_align_left">
                                          <div class="orders_img">
                                             <figure><img src="{{ asset('images/gchoco/orders1.png') }}" alt="#"/></figure>
                                             <div class="price">
                                                <span>PRICE<br>$300</span>
                                             </div>
                                          </div>
                                    ...
                                    <div class="row">
                                       <div class="col-md-3">
                                          <div class="customers_pro">
                                             <figure><img src="{{ asset('images/gchoco/test_pro.png') }}" alt="#"/></figure>
                                          </div>
                                       </div>
                                       <div class="col-md-9">
                                          <div class="cos_text text_align_left">
                                             <h3>DIANA MORJU</h3>
                                             <p>using 'Content here, content here', making it look like readable English. Many desktop publishing packages and web page editors now use Lorem Ipsum as their default model text, and a search <img src="{{ asset('images/gchoco/icon.png') }}" alt="#"/></p>
                                          </div>
                                       </div>
                                    </div>
                                 </div>
                        ...
                        <div class="col-md-6">
                           <div class="infoma text_align_left">
                              ...
                              <ul class="conta">
                                 ...
                                 <li><img src="images/ma.png" alt="#"/> <a href="Javascript:void(0)"> demo@gmail.com</a></li>
