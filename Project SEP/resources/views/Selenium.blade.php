    ...
    <div class="wrapper">
        ...
        <nav id="sidebar">
            <div class="sidebar-header">
                <div class="logo">
                    <a href="index.html"><img src="{{ asset('images/selenium/logoseleniumramen.png') }}" alt="#" /></a>
                </div>
            </div>
            <ul class="list-unstyled components">
                ...
                <li>
                    <a href="sugarfree.html"> <i class="fa fa-angle-right" aria-hidden="true"></i>Sugar Free
                        Chocolates</a>
                </li>
                <li>
                                            ...
                                            <div class="carousel-caption relative">
                                                <div class="row">
                                                    <div class="col-md-12">
                                                        <div class="designer">
                                                            <h1>Chocolates</h1>
                                                            <span>long established fact that a reader will be distracted
                                                                by the readable content </span>
                                                            <figure><img src="{{ asset('images/gchoco/choc.png') }}"
                                                                    alt="#" /></figure>
                                                            <div class="cho_more">
